...
const manufacturerCcpPath = path.resolve(__dirname, '..', 'fabric', 'connection-manufacturer.json');
const manufacturerCcpFile = fs.readFileSync(manufacturerCcpPath, 'utf8');
const manufacturerCcp = JSON.parse(manufacturerCcpFile);

const consumerCcpPath = path.resolve(__dirname, '..', 'fabric', 'connection-consumer.json');
